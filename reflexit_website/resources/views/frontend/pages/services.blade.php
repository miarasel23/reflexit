    ...
    <!--Full width header End-->
      ...
      <div class="rs-breadcrumbs img3">
        <div class="breadcrumbs-inner text-center">
          ...
          <ul>
            <li title="Braintech - IT Solutions and Technology Startup HTML Template"><a class="active" href="index.html">Home</a></li>
            <li title="Go To Services"><a class="active" href="index.html">Services</a></li>
          </ul>
        </div>
      </div>
      <!-- Breadcrumbs End -->
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 md-mb-50">
              ...
              <h2 class="mt-34">We Offering all Kind of IT Services & Solutions</h2>
              <p>
                ...
                dictum, ex accumsan eleifend eleifend, ex justo aliquam nunc, in
                ultrices ante quam eget massa. Sed scelerisque, odio eu tempor
                pulvinar, magna tortor finibus lorem, ut mattis tellus nunc ut
                quam. Curabitur quis ornare leo. Suspendisse bibendum nibh non
                turpis vestibulum pellentesque.
              </p>
              <ul class="listing-style">
                <li>
                  <i class="fa fa-check-circle"></i>
                  <span> Super Fast Respons</span>
                </li>
                <li>
                  <i class="fa fa-check-circle"></i>
                  <span> Profetionalism</span
                  >
                </li>
              ...
              <p class="mt-20 mb-50">
                ...
                dictum, ex accumsan eleifend eleifend, ex justo aliquam nunc, in
                ultrices ante quam eget massa. Sed scelerisque, odio eu tempor
                pulvinar, magna tortor finibus lorem.
              </p>
              <!-- <div class="row mb-80">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-lg-3 text-right col-md-12">
                <div class="button-wrap">
                  <a class="readon learn-more" href="contact.html"
                    >Get In Touch</a
                  >
                </div>
              </div>
